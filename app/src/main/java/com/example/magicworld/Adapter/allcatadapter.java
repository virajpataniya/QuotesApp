...
import com.example.magicworld.Model.AllCategorymodel;
import com.example.magicworld.R;
import com.example.magicworld.categoryactivities.SameListActivity;
    ...
    public void onBindViewHolder(@NonNull catviewholder holder, int position) {
        ...
        holder.imgCat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, SameListActivity.class);
                intent.putExtra("Jokes",temp.getImage());
